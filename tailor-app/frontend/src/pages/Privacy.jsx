  ...
  return (
    <>
      ...
      <div className='privacy-policy-container'>
        ...
        <p className='intro'>
          Tailor respects your privacy. This Privacy Policy explains how we collect, use, and protect your information when using our
          services, particularly with regard to data retrieved from Pinterest.
        </p>
        ...
        <section className='section'>
          ...
          <ul className='section-list'>
            <h4>
              <strong>With Cohere API:</strong> To analyze images and generate insights.
            </h4>
          </ul>
          <p className='section-content'>
        ...
        <section className='section'>
          ...
          <p className='section-content'>Retrieved Pins are stored in our app until the user chooses to delete them.</p>
          <p className='section-content'>Users can remove any saved Pins from their mood boards at any time.</p>
        </section>

        <section className='section'>
          <h2 className='section-title'>Security Measures</h2>
          <p className='section-content'>
            We implement industry-standard security measures, including encrypted data storage and secure API connections, to protect user
            data.
          </p>
        </section>
        ...
        <section className='section'>
          ...
          <p className='section-content'>For any privacy-related inquiries, please contact us at:</p>
          <p className='contact-details'>
            <strong>Email:</strong> <a href='mailto:tailorfashionai@gmail.com'>tailorfashionai@gmail.com</a>
          </p>
          <p className='contact-details'>
            <strong>Website:</strong>{' '}
            <a href='https://tailor-4d71417e9aab.herokuapp.com/' target='_blank' rel='noopener noreferrer'>
              https://tailor-4d71417e9aab.herokuapp.com/
            </a>
          </p>
        </section>
      </div>
