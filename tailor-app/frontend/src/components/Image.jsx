...
const Image = ({id, CustomComponent, properties, imageIdSelected, handleDelete, handleSelect, imageEdit, bringToFront, saveToHistory, historyDone, isRefreshHistory, boardRef, urls}) => {
  ...
  return  (
      ...
      >
        <div 
          ref={divRef}
          onClick={onClick}
          style={{ zIndex: properties.get('zIndex'),
