...
def test_insert_moodboard_success(
    mock_delete_document, mock_find_documents, mock_insert_document, mock_upload_file, client
):
    ...
    mock_find_documents.assert_called_once_with("user_123", "temp_boards", {"prompt": "test prompt"})
    mock_delete_document.assert_called_once_with("user_123", "temp_boards", "507f1f77bcf86cd799439011")
